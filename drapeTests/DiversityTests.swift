...
//  drapeTests
//
//  The returned set is chosen by Maximal Marginal Relevance, so the surfaced
//  cards differ by more than a single swapped slot instead of being near-duplicate
//  top-N-by-score.
//
