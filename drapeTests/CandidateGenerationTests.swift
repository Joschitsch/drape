...
//  drapeTests
//
//  Phase 1: candidate generation now pre-ranks each slot and trims
//  deterministically instead of building the full cross product and randomly
//  truncating it. These pin that a clearly-best outfit is always considered,
//  even in a large wardrobe, and that a locked garment survives the cap.
//
