...
enum AttributeEval {
    ...
    static var specs: [AttributeSpec] {
        [
            ...
            .init(name: "topLength",
                  groundTruth: { $0.groundTruth?.topLength?.rawValue },
                  inferred: { $0.inferred.topLength?.rawValue }),
            .init(name: "bottomVolume",
                  groundTruth: { $0.groundTruth?.bottomVolume?.rawValue },
